...
const mapDef: PartialMapDef = {
    ...
    desc: {
        name: "soloPetBot",
        icon: "img/loot/loot-perk-gotw.svg",
    ...
    gameMode: { maxPlayers: 80, botPetMode: true },
    ...
    adrenModeConfig: {
        adrenMode: true,
        adrenTotal: 400,
        adrenSpeedBoost: 0.02,
        adrenHealBoost: 0.015,
    }
};
export const SoloPetBot = util.mergeDeep({}, Main, mapDef) as MapDef;
